...
#define UV_DATA_EXTREME 11
#define UV_DATA_VERY_HIGH 8
#define UV_DATA_HIGH 6
#define UV_DATA_MODERATE 3
#define UV_DATA_LOW 0

#define INT_OUTPUT_RESET 0x00
#define INT_OUTPUT_SET 0x01

static const uint8_t UV_COEF[]={0x7B,0x6B,0x01,0x00};



typedef struct __SI1145_TypeDef
{
	uint16_t raw_data[6];
	uint16_t aux_data;
	double uv_index; 
	...
	uint8_t int_output_status;
	HAL_StatusTypeDef i2c_status;
	
	uint32_t uv_accumulation;
	double uv_index_average;
...
//I2C functions
char Si1145_I2C_Mem_Read(SI1145_TypeDef *p_handle_si1145,unsigned char register_addr);
void Si1145_I2C_Mem_Read_Multibyte(SI1145_TypeDef *p_handle_si1145,unsigned char register_addr,unsigned char *DATA_Rx,unsigned int data_num);
void Si1145_I2C_Mem_Write(SI1145_TypeDef *p_handle_si1145,unsigned int register_addr,unsigned char DATA_Tx);
void Si1145_I2C_Mem_Write_Multibyte(SI1145_TypeDef *p_handle_si1145,unsigned char register_addr,unsigned char *DATA_Tx,unsigned int data_num);
...
void Si1145_Init(I2C_HandleTypeDef *hi2c,SI1145_TypeDef *handle_si1145);
void Si114x_Reset(SI1145_TypeDef *p_handle_si1145);
void Si1145_Get_Data(SI1145_TypeDef *p_handle_si1145);
void Send_UV_Index(void);
void Send_accumulate_data(unsigned int minute);
